...
from CDPR.ConfidencePredictor import SimpleUNet, CNNBackbone, ResNet18Backbone, MLPBackbone
...
class CDPRDepthPipeline(DiffusionPipeline):
    """
    ...
    def __call__(
        ...
        duplicated_pol = pol_norm.expand(ensemble_size, -1, -1, -1)
