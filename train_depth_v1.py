...
from CDPR.CDPR_depth_pipeline_v1 import CDPRDepthPipeline
...
if "__main__" == __name__:
    ...
    parser = argparse.ArgumentParser(
        description="CDPR : Monocular Depth Estimation : Training"
    )
    parser.add_argument(
        "--config",
        type=str,
        default="config/train_cdpr_depth_v1.yaml",
    ...
    model = CDPRDepthPipeline.from_pretrained(
