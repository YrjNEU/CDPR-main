...
from CDPR.CDPR_depth_pipeline_v1 import CDPRDepthPipeline, CDPRDepthOutput
...
class CDPRDepthTrainer:
    def __init__(
        self,
        cfg: OmegaConf,
        model: CDPRDepthPipeline,
        ...
        self.model: CDPRDepthPipeline = model
        self.device = device
        ...
        for epoch in range(self.epoch, self.max_epoch + 1):
            ...
            for batch in skip_first_batches(self.train_loader, self.n_batch_in_epoch):
                ...
                with torch.no_grad():
                    ...
                    pol_latent = self.encode_pol(pol)
                    # Encode GT depth
    ...
    def encode_pol(self, pol_in):
        assert len(pol_in.shape) == 4 and pol_in.shape[1] == 3
        latent = self.model.encode_rgb(pol_in)
        return latent
